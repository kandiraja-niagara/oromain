...
class Data {
  ...
  List<Selector>? selectorForCentral;
  List<Selector>? selectorForLocal;
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    return Data(
      ...
      localFilterSite: json["irrigationLine"] == null ? [] : List<NameData>.from(json["irrigationLine"]!.map((x) => NameData.fromJson(x))),
      ...
      selectorForCentral: json["centralSelector"] == null ? [] : List<Selector>.from(json["centralSelector"]!.map((x) => Selector.fromJson(x))),
      selectorForLocal: json["localSelector"] == null ? [] : List<Selector>.from(json["localSelector"]!.map((x) => Selector.fromJson(x))),
    );
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    return {
      ...
      "centralFilter": localFilterSite == null ? [] : List<dynamic>.from(localFilterSite!.map((x) => x.toJson())),
      "localFilterSite": localFilter == null ? [] : List<dynamic>.from(localFilter!.map((x) => x.toJson())),
