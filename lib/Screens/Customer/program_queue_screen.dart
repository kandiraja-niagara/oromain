...
class ProgramQueueScreen extends StatefulWidget {
  ...
  const ProgramQueueScreen({Key? key, required this.userId, required this.controllerId, required this.customerId, required this.deviceId}) : super(key: key);
                ...
                OutlinedButton(
                    onPressed: () async{
                      ...
                      try {
                        ...
                        manager.publish(payload.toString(), "AppToFirmware/${widget.deviceId}");
